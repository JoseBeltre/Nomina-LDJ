                ...
                <div class="col-md-6">
                    <div class="card shadow-sm">
                        <div class="card-header">
                            <h2 class="card-title m-2 text-center fw-bold text-primary">Editar Empleado</h2>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="procesar.php" method="post">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombres" name="nombres" disabled readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="submit" class="btn btn-primary  m-auto d-block">Actualizar</button>
                            </form>
                        </div>
                    </div>
                </div>
